...
class Services extends Component {
  ...
  servicedata = [
    ...
    },
    {
      ...
      title: "Trainings",
      desc:
        "GAT Consulting also trains professionals from organizations aiming to build capacity of their staff in survey management, data collection, data analysis and monitoring and evaluation. We customize our comprehensive training modules on the basis of requirements and needs of the organizations",
    },
    {
      imglink: Supply,
      title: "Supplies and Logistics",
      desc:
        "In addition to our core services, GAT Consulting also has the capacity to manage complex logistics and end to end supply operations in collaboration with its partners. In the past GAT Consulting has managed logistics and supplies of books, engineering and horticultural equipment for its clients.",
    },
  ];
    ...
    return (
      <div className="App">
        ...
        <div
          ...
          style={{ backgroundColor: "#7B1FA2", marginBottom: "50px" }}
        >
